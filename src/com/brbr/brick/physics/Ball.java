...
public class Ball extends GameObject {
    ...
    public Ball(){
        super();
        transform = new Transform((int)(Math.random() * (400 - Coordinates.BALL_SIZE)), 680 - Coordinates.BALL_SIZE);
        collider = (CircleCollider)(addComponent(new CircleCollider(Coordinates.BALL_SIZE / 2)));
